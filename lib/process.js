...
var addEntry = function(sb, stationID, monthNum, date, e, dummy) {
  sb.append('\tHeatMapData.insert({')
  ...
  data.forEach(function(e, index) {
    if (months.indexOf(e.date) > -1) {
      ...
      while (dateFromFile != date) {
        ...
        //Create dummy entry
        sb = addEntry(sb, stationID, monthNum, date, {tempHigh: '-274   ', tempAvg: '-274   ', tempLow: '-274   ', rain: '0   '}, true)
        date++
      }
      ...
      //Create real entry
      sb = addEntry(sb, stationID, monthNum, date, e, false)
